...
eval "::AESL_LIB_XILADAPTER::m_axi_gen { \
    ...
    max_latency -1 \ 
    delay_budget 8.75 \ 
    name {TOPANN_Inputs_m_axi} \
} "
} else {
puts "@W \[IMPL-110\] Cannot find AXI interface model in the library. Ignored generation of AXI interface for 'Inputs'"
}
}

if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler TOPANN_Inputs_m_axi
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler TOPANN_Output_r_m_axi
}
