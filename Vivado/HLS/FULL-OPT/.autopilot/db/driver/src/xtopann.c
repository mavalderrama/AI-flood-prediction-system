...
u32 XTopann_Get_inputs_V_BaseAddress(XTopann *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return (InstancePtr->Axilites_BaseAddress + XTOPANN_AXILITES_ADDR_INPUTS_V_BASE);
}

u32 XTopann_Get_inputs_V_HighAddress(XTopann *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return (InstancePtr->Axilites_BaseAddress + XTOPANN_AXILITES_ADDR_INPUTS_V_HIGH);
}

u32 XTopann_Get_inputs_V_TotalBytes(XTopann *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return (XTOPANN_AXILITES_ADDR_INPUTS_V_HIGH - XTOPANN_AXILITES_ADDR_INPUTS_V_BASE + 1);
}

u32 XTopann_Get_inputs_V_BitWidth(XTopann *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return XTOPANN_AXILITES_WIDTH_INPUTS_V;
}

u32 XTopann_Get_inputs_V_Depth(XTopann *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return XTOPANN_AXILITES_DEPTH_INPUTS_V;
}

u32 XTopann_Write_inputs_V_Words(XTopann *InstancePtr, int offset, int *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);

    int i;

    if ((offset + length)*4 > (XTOPANN_AXILITES_ADDR_INPUTS_V_HIGH - XTOPANN_AXILITES_ADDR_INPUTS_V_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(int *)(InstancePtr->Axilites_BaseAddress + XTOPANN_AXILITES_ADDR_INPUTS_V_BASE + (offset + i)*4) = *(data + i);
    }
    return length;
}

u32 XTopann_Read_inputs_V_Words(XTopann *InstancePtr, int offset, int *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(int *)(InstancePtr->Axilites_BaseAddress + XTOPANN_AXILITES_ADDR_INPUTS_V_BASE + (offset + i)*4);
    }
    return length;
}

u32 XTopann_Write_inputs_V_Bytes(XTopann *InstancePtr, int offset, char *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);

    int i;

    if ((offset + length) > (XTOPANN_AXILITES_ADDR_INPUTS_V_HIGH - XTOPANN_AXILITES_ADDR_INPUTS_V_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(char *)(InstancePtr->Axilites_BaseAddress + XTOPANN_AXILITES_ADDR_INPUTS_V_BASE + offset + i) = *(data + i);
    }
    return length;
}

u32 XTopann_Read_inputs_V_Bytes(XTopann *InstancePtr, int offset, char *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(char *)(InstancePtr->Axilites_BaseAddress + XTOPANN_AXILITES_ADDR_INPUTS_V_BASE + offset + i);
    }
    return length;
}
...
u32 XTopann_Get_result_V_BaseAddress(XTopann *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return (InstancePtr->Axilites_BaseAddress + XTOPANN_AXILITES_ADDR_RESULT_V_BASE);
}

u32 XTopann_Get_result_V_HighAddress(XTopann *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return (InstancePtr->Axilites_BaseAddress + XTOPANN_AXILITES_ADDR_RESULT_V_HIGH);
}

u32 XTopann_Get_result_V_TotalBytes(XTopann *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return (XTOPANN_AXILITES_ADDR_RESULT_V_HIGH - XTOPANN_AXILITES_ADDR_RESULT_V_BASE + 1);
}

u32 XTopann_Get_result_V_BitWidth(XTopann *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return XTOPANN_AXILITES_WIDTH_RESULT_V;
}

u32 XTopann_Get_result_V_Depth(XTopann *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return XTOPANN_AXILITES_DEPTH_RESULT_V;
}

u32 XTopann_Write_result_V_Words(XTopann *InstancePtr, int offset, int *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);

    int i;

    if ((offset + length)*4 > (XTOPANN_AXILITES_ADDR_RESULT_V_HIGH - XTOPANN_AXILITES_ADDR_RESULT_V_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(int *)(InstancePtr->Axilites_BaseAddress + XTOPANN_AXILITES_ADDR_RESULT_V_BASE + (offset + i)*4) = *(data + i);
    }
    return length;
}

u32 XTopann_Read_result_V_Words(XTopann *InstancePtr, int offset, int *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(int *)(InstancePtr->Axilites_BaseAddress + XTOPANN_AXILITES_ADDR_RESULT_V_BASE + (offset + i)*4);
    }
    return length;
}

u32 XTopann_Write_result_V_Bytes(XTopann *InstancePtr, int offset, char *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);

    int i;

    if ((offset + length) > (XTOPANN_AXILITES_ADDR_RESULT_V_HIGH - XTOPANN_AXILITES_ADDR_RESULT_V_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(char *)(InstancePtr->Axilites_BaseAddress + XTOPANN_AXILITES_ADDR_RESULT_V_BASE + offset + i) = *(data + i);
    }
    return length;
}

u32 XTopann_Read_result_V_Bytes(XTopann *InstancePtr, int offset, char *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(char *)(InstancePtr->Axilites_BaseAddress + XTOPANN_AXILITES_ADDR_RESULT_V_BASE + offset + i);
    }
    return length;
}
