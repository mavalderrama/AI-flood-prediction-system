...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename Ainputs \
    op interface \
    ports { Ainputs_address0 { O 2 vector } Ainputs_ce0 { O 1 bit } Ainputs_we0 { O 1 bit } Ainputs_d0 { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'Ainputs'"
}
}
